...
app.get("/customers", async (req: Request, res: Response) => {
  ...
  try {
    ...
    // When creating custom tables with custom table names be careful of using get many as it returns entity
    // instances instead of the raw sql, use raw methods when you want to create something custom
