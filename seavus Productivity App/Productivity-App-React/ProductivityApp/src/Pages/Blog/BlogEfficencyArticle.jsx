    ...
    <>
      ...
      <div className="blog-sections">
        <section id="section-0">
          <p>
            Hearing the word “motivation” many people immediately imagine a system of fines and bonuses for staff that directly depends upon the
            quantity and quality of the work done. Our dislike towards any rating system is deep-rooted in our thoughts. Majorly because that is how
            our education system works, where good test score is a reward and you are perceived as a smart, intelligent and hardworking student. While
          ...
          <p>
            The crucial thing is to change the perception towards words such as control, monitor, reviews, checks, audits, etc. In an organization,
            such terms do not always correlate to managing motivations through fines and bonuses as per work. But to find potential growth points for
            the whole company. An effective way to find them is to conduct regular , or in simple terms, checks. Thus, the process of monitoring
            employees reshapes into a way to improve the entire company’s work.
          </p>
        </section>
        <section id="section-1">
          ...
          <ul>
            <li>
              <p>
                <b>Motivate the staff with assessments</b>
              </p>
            </li>
          </ul>
          <p>
          ...
          <p>
            ...
            well enough. It is not ideal to pay extra for fulfilling the basic requirements of the company. Logic dictates bonus amount being
            proportional to the degree of compliance with the established standards. It will be more reasonable to allocate additional bonuses for the
            work performed above the basic requirement.
          </p>
          <ul>
            <li>
              <p>
                <b>Encourage productive initiative</b>
              </p>
            </li>
          </ul>
          <p>
            One of the problems of large companies is it is very easy to be overlooked among large numbers of employees, even if you work better than
            others. Obviously, if you do not notice an employee who took the initiative, it will play against their motivation. Even if they do not
          ...
          <p>
            ...
            presenting the option of placing a new collection in the women's area. One of the managers also presented options for men's and children's
            areas. In this case, you immediately see the employee's initiative and if it is successful, you can send it to other managers as a sample
            in real-time.
          </p>
          <p>In this way, you motivate the proactive manager to continue their efforts and quickly implement good ideas across the network.</p>
          <ul>
            <li>
              <p>
                <b>Create a high potentials pool&nbsp;</b>
              </p>
            </li>
          </ul>
          <p>
            The best talent grows inside a company. They know the company’s work from the inside. It is not easy to identify such employees. Those who
            rush into leadership roles are not always good candidates as they would like to be. Evaluating their work must be performed based on their
            actual performances.
          </p>
          <p>
          ...
          <p>
            ...
            they will be motivated to work more effectively.
          </p>
          <ul>
            <li>
              <p>
                <b>Motivate staff to learn&nbsp;</b>
              </p>
            </li>
          </ul>
          <p>
          ...
          <ol>
            <li>
              <p>The auditee will learn updated company information, and</p>
            </li>
            <li>
              <p>Auditors will learn not to be in a situation where they know less than the auditee.</p>
            </li>
          </ol>
          <ul>
            <li>
              <p>
                <b>Use gamification of work processes for motivation&nbsp;</b>
              </p>
            </li>
          </ul>
          <p>
          ...
          <p>
            ...
            regularly evaluates the point of sale throughout the campaign. The staff members can see intermediate results in real-time (Productivity
            App has that feature). This further instills healthy competition and plays a positive role in staff motivation.
          </p>
        </section>
...
export default BlogEfficencyArticle;
